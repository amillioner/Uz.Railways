...
//// Updated Controllers/UploadController.cs (with authorization)
//using Microsoft.AspNetCore.Authorization;
//using Microsoft.AspNetCore.Mvc;
//using RailApi.Constants;
//using RailApi.Services;
...
//        try
//        {
//            var jobId = await _csvProcessingService.ProcessCsvAsync(file);
...
//    [ProducesResponseType(StatusCodes.Status401Unauthorized)]
//    [ProducesResponseType(StatusCodes.Status403Forbidden)]
//    public async Task<ActionResult> GetUploadStatus(string jobId)
//    {
//        var status = await _csvProcessingService.GetJobStatusAsync(jobId);
